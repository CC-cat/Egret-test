var assets = {
  ...
  button_l: "openDataContext/assets/button.png",
  button_r: "openDataContext/assets/button.png",
...
function drawByData(data, i) {
  ...
  context.fillText(data.scroes / 1000 + "秒", x, startY + i * preOffsetY + textOffsetY, textMaxSize);
